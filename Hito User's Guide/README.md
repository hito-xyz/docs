...
6. Because your Hito wallet is a signing device, to make a transaction it must be used with an application in one of two ways
      - with the Hito app that works on iPhone or Android - you will first need to download Testflight, then you will pair your Hito wallet; follow the steps [here](https://testflight.apple.com/join/0fOZD2hD)
